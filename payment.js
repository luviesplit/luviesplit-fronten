document.addEventListener('DOMContentLoaded', function () {
    const stripe = Stripe('pk_test_your_publishable_key'); // Замени на реальный ключ
    ...
    // Import utilities
    const { showMessage, validateEmail, validatePassword, formatLVT, formatEcoImpact } = window;
    ...
    marsPaymentButton.addEventListener('click', function () {
        showMessage(feeMessage, 'Mars Mode payments with LuvieChain coming soon!', false);
    });
});